def unsafe(app, args, out, virtual_input):
    ...
    It wraps the execution of the specified `app` function,
    catches any exceptions, clears the output buffer,
    prints the error message, and returns the cleared output.
    ...
    - virtual_input (deque): A deque representing input received
